/**
 * Fixed "Important note" + "Return transfer" pair shown below the pricing
 * content on every /services page (listing and detail). Content differs per
 * page (route-specific vs generic) but the design is shared.
 */
export default function ServicePricingNotices({
  whatsappHref,
  returnTitle,
  returnBody,
  idealFor,
  ...
  return (
    <div className={`grid gap-6 ${showReturnTransfer ? "lg:grid-cols-2" : "max-w-xl"}`}>
